package io.dunyalabs.kafka.config;
...
/*	@Bean
	...
	@Bean
	public ConsumerFactory<String, Data> jsonConsumerFactory() {
		Map<String, Object> props = new HashMap<>();
		props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, IKafkaConstants.KAFKA_BROKERS);
		props.put(ConsumerConfig.GROUP_ID_CONFIG, IKafkaConstants.GROUP_ID_CONFIG_JSON);
		props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
	...
	@Bean
	public ConcurrentKafkaListenerContainerFactory<String, Data> jsonKafkaListenerContainerFactory() {
